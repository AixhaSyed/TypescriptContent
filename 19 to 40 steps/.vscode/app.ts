import {add , sub} from './main.ts'   //simple funtion export krwane k lyn
import cal from './main'              //default function export krwane k lyn 
import * as abc from './index.ts'     //ye pore file uthae ga index ke nd ab c m xave krwa lega 
import * as abc1 from './main.ts'     //main ke woo woo cheezn uthae ga jou k export ke key words k xth hnn 

var addResult = add (2,3 )
// console.log(abc.add (20,30));
